    ...
    public CheckoutResponse createCheckoutSessionUrl(CheckoutRequest request) {
        ...
        try {
            ...
            if(stripeUserId == null || stripeUserId.isBlank()) {
                ...
                params.setCustomer(stripeUserId);
            }
